    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-primary text-primary-foreground shadow hover:bg-primary/90 hover:shadow-neon": variant === "default",
            "border border-border bg-transparent hover:bg-accent hover:text-accent-foreground": variant === "outline",
            "hover:bg-accent hover:text-accent-foreground": variant === "ghost",
            "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90": variant === "danger",
            "bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 hover:shadow-glass": variant === "glass",
